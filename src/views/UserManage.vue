...
export default {
    ...
    methods: {
        ...
        getData() {
            axios.get("/main/getUser", { params: {page:this.page.page,count:this.page.count,studentName: this.formInline.studentName, userName: this.formInline.userName } }).then(res => {
                console.log(res, 'msg');
