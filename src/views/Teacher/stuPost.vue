        ...
        <div class="UserManage_box">
            <div class="UserManage_Search">
                <el-form :inline="true" :model="formInline" style="margin: 0px auto;">
                    <el-form-item label="学生姓名">
                        <el-input v-model="formInline.studentName" placeholder="支持模糊查询"></el-input>
                    </el-form-item>

                    <el-form-item label="公司名" style="margin-left: 20px;">
            ...
            <div>
                ...
                <el-table :data="tableData" style="width: 90%;border-radius: 5px;margin: 0 auto;">
                    ...
                    <el-table-column prop="companyName" label="实习公司">
                    </el-table-column>
                    <el-table-column prop="postName" label="实习岗位">
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
              ...
              console.log()
            axios.get("/main/getStuPost", { params: { page: this.page.page, count: this.page.count, classID:this.teacher.classID,studentName:this.formInline.studentName,companyName:this.formInline.companyName} }).then(res => {
                console.log(res, 'tea');
