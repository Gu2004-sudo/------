<template>
    <div style="width: 90%;margin: auto;">
        <div style="margin-top: 50px; padding-left: 75px;">
            <label>学生姓名: </label>
        ...
        <el-table :data="tableData" style="width: 100%;margin-top: 30px" @expand-change="selectPost" ref="refTable">
            ...
            <el-table-column width="140px" label="是否对口" prop="isPractice">
                <!-- <template slot-scope="scope">
            ...
            <el-table-column width="140px" label="佐证材料" prop="">
                <template slot-scope="scope">
            ...
            <el-table-column label="操作" fixed="right" width="270">
                <template slot-scope="scope">
                    <div v-for="post, index in ObtainEmployment" :key="index">
                        <el-link v-if="scope.row.studentID == post.studentID" style="color: #ccc;" type="error"
                            icon="el-icon-plus" disabled title="已有就业信息,不可在进行添加">添加</el-link>
                        <el-link v-else-if="scope.row.studentID != post.studentID" type="primary" icon="el-icon-plus"
                            @click="insert(scope.row)">添加</el-link>
        ...
        <el-dialog title="添加记录" :visible.sync="dialogFormVisible" @close="handClose" width="500px">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="公司名称" style="width: 330px;">
                    <el-select v-model="ruleForm.companyID" placeholder="请选择">
                        <div v-for="com in companyAll">
                            <el-option :value="com.companyID" :label="com.companyName"></el-option>
                        </div>
    ...
    methods: {
        ...
        insertPost() {
            ...
            axios.post("/main/insertPracticePost", JSON.stringify(this.ruleForm), {
                ...
                this.updatetStudent();
                this.student.fileSrc = this.fileName
                this.dialogFormVisible = false
                this.selectPostWC();
            })
        ...
        isUpdatePost() {
            this.dialogForm = false
            axios.put("/main/updatePost", JSON.stringify(this.from), {
                headers: {
                    'Content-Type': 'application/json',
                }
            }).then(res => {
